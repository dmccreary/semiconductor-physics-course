---
title: List of MicroSims for Semiconductor Physics
description: Interactive MicroSims for the Semiconductor Physics course — crystal structure, quantum mechanics, band theory, carrier statistics, and defect physics.
hide:
    toc
---
...
-   **[Cubic Crystal Structure Explorer](./cubic-crystal-structure-explorer/index.md)**
    ...
    ![Cubic Crystal Structure Explorer](./cubic-crystal-structure-explorer/cubic-crystal-structure-explorer.png)
...
-   **[Dimensionality and Density of States Explorer](./density-of-states-explorer/index.md)**
    ...
    ![Dimensionality and Density of States Explorer](./density-of-states-explorer/density-of-states-explorer.png)
...
-   **[Direct vs. Indirect Bandgap E-k Explorer](./direct-indirect-bandgap-explorer/index.md)**
    ...
    ![Direct vs Indirect Bandgap E-k Explorer](./direct-indirect-bandgap-explorer/direct-indirect-bandgap-explorer.png)
...
-   **[E-k Band Structure Explorer](./ek-band-structure-explorer/index.md)**
    ...
    ![E-k Band Structure Explorer](./ek-band-structure-explorer/ek-band-structure-explorer.png)
...
-   **[Fermi-Dirac Distribution and Carrier Concentration Explorer](./fermi-dirac-explorer/index.md)**
    ...
    ![Fermi-Dirac Distribution Explorer](./fermi-dirac-explorer/fermi-dirac-explorer.png)
...
-   **[Miller Indices Crystal Plane Explorer](./miller-indices-explorer/index.md)**
    ...
    ![Miller Indices Explorer](./miller-indices-explorer/miller-indices-explorer.png)
...
-   **[Point Defect Visualizer](./point-defect-visualizer/index.md)**
    ...
    ![Point Defect Visualizer](./point-defect-visualizer/point-defect-visualizer.png)
...
-   **[Quantum Tunneling Probability Explorer](./quantum-tunneling-explorer/index.md)**
    ...
    ![Quantum Tunneling Explorer](./quantum-tunneling-explorer/quantum-tunneling-explorer.png)
...
-   **[Temperature Dependence of n_i Explorer](./intrinsic-concentration-temperature/index.md)**
    ...
    ![Temperature Dependence of n_i](./intrinsic-concentration-temperature/intrinsic-concentration-temperature.png)
