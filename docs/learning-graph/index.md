...
connected by directed edges that indicate what concepts each node depends on before
that concept is understood by the student.
...
This learning graph contains **600 concepts** organized into **16 taxonomy categories**
spanning semiconductor fundamentals through advanced device physics, with **1,075 directed
dependency edges** encoding the prerequisite structure of the course.
...
- Longest dependency chains: 32 hops (Wave-Particle Duality → Tandem Solar Cell)
...
create 16 categories for our concepts and then place each concept
...
- Balanced categories (1.8% – 9.5% each)
...
- Balance verification: ✅ Excellent balance (spread: 7.7%)
